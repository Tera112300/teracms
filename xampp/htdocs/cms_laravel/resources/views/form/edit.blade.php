...
<section class="content">
  ...
  <div class="ttl_wrap">
    ...
    <input type="text" class="form-control @if($errors->has('form_title')) is-invalid @endif" placeholder="Title" aria-label="Username" aria-describedby="basic-addon1" name="form_title" value="{{$forms_id->form_title}}">
    ...
    <div class="tab_wrap">
      ...
      <ol class="tab_content">
        <li class="active">
          ...
          <span contenteditable="false" class="form_tag_clipboard form_top" data-clipboard-target="#clipboard-target">&lt;form action="<span class="action_url">{{$forms_id->action}}</span>" id="form" method="POST" &gt;<span>&lt;table class="form_table"&gt;</span></span>
            <div class="contenteditable_js" contenteditable="true">{!! $forms_id->html_tag !!}</div>
          ...
          <textarea class="hidden_textarea" name="html_tag">{{ $forms_id->html_tag }}</textarea>
        </li>
        <li class="">
          ...
          <table class="mail_table">
            <tr>
              ...
              <td>
                <input type="url" class="form-control @if($errors->has('action')) is-invalid @endif" id="google_action" placeholder="送信先" name="action" value="{{$forms_id->action}}">
